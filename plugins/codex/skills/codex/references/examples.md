...
**Result**: Code-related task uses gpt-5.4 with read-only sandbox (default). No file modifications.
...
**Result**: General task uses gpt-5.4 with read-only sandbox (default). Session automatically saved for continuation.
...
**Result**: Code-related research uses gpt-5.4 with read-only sandbox (default) and web search enabled.
...
**Result**: User explicitly said "Edit this file" - code task uses gpt-5.4 with workspace-write permissions.
...
**Result**: User explicitly said "Refactor and save" - code task uses gpt-5.4 with workspace-write for file modifications.
